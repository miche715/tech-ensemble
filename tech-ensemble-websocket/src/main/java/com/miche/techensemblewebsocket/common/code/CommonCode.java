package com.miche.techensemblewebsocket.common.code;

public class CommonCode {
    public static final String VERTICLE_TYPE_ONE = "one";
    ...
    public static final String EVENT_BUS_ADDRESS_THREE = "event-bus-address-three";

    public static final String TOPIC_100 = "topic-100";
    public static final String TOPIC_200 = "topic-200";
    public static final String TOPIC_300 = "topic-300";

    public static final String GROUP_101 = "group-101";
    public static final String GROUP_201 = "group-201";
    public static final String GROUP_301 = "group-301";
}