...
public class TwoVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) {
        MessageConsumer<VertxMessageRecord> messageConsumer = vertx.eventBus().consumer("event-200");  // event-100 주소로 부터 받음.
